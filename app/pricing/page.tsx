...
export const metadata: Metadata = {
  title: "Pricing & Registration — €800 / €1200 | Elite Wrestling Camp Switzerland 2026",
  description:
    "Elite Wrestling Camp Switzerland 2026 pricing: Camp Only €800 (training & coaching) or Full Package €1200 (accommodation + meals included). Only 30 spots. Reserve yours today.",
  keywords: [
  ...
  openGraph: {
    title: "Pricing — Elite Wrestling Camp Switzerland 2026",
    description:
      "Camp Only €800 or Full Package €1200 with accommodation & meals. Only 30 spots available. Register now.",
    type: "website",
    images: [{ url: "/head-photo.jpg", width: 1200, height: 630, alt: "Elite Wrestling Camp Pricing" }],
  },
